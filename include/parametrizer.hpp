...
class Parametrizer {
   public:
    ...
    void Initialize(double faces, double angle);
    ...
    MatrixXd N_new;
    MatrixXd Q_new;
    std::vector<std::vector<int>> Vset_new;
    std::vector<Vector3d> O_compact_new;
    std::vector<Vector4i> F_compact_new;
    std::vector<int> V2E_compact_new;
    std::vector<int> E2E_compact_new;
    double mScale_new;
    std::vector<Vector3d> diffs_new;
    std::vector<int> diff_count_new;
    std::vector<int> sharp_o_new;
    std::map<int, std::pair<Vector3d, Vector3d>> compact_sharp_constraints_new;
    std::vector<int> boundary_o_new;
    std::map<int, std::pair<Vector3d, Vector3d>> compact_boundary_constraints_new;
    ...
    std::vector<double> CornerP;
    std::vector<double> Holeposition;
