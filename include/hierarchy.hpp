...
class Hierarchy {
   public:
    ...
    std::vector<int> mcorner;
    std::vector<double> mcornerP;
    std::vector<int> mcornerQ;
    std::vector<double> mtriangle;
    std::vector<int> mface;
    std::vector<int> mstart;
    std::vector<int> mboundaryvertex;
    std::vector<int> msharpvertex;
    std::vector<double> mholeposition;
    std::vector<int> mhole;
    std::vector<double> mholeP;
    std::vector<int> mholeP1;
    std::vector<int> munchangeB;
    std::vector<int> mlinetype;
    /*std::vector<int> mboudnary_edges;
    std::set<int> mboundary_vertices;
    std::map<int, std::pair<Vector3d, Vector3d>> mboudnary_constraints;*/
